...
const MESSAGES: Record<Locale, Messages> = {
  zh: {
    ...
    stage: {
      ...
      votesUnit: "票",
      relatedTitle: "相关观点",
      relatedHint: "悬停预览 · 点击切换（语义相似/父链/同层/子节点）",
      relatedSimilar: "语义相似",
      relatedSimilarPending: "AI 分析中…",
      relatedSimilarEmpty: "暂无相似观点",
      relatedPath: "父链",
  ...
  en: {
    ...
    stage: {
      ...
      relatedSimilarPending: "AI analysis running…",
      relatedSimilarEmpty: "No similar items",
      relatedPath: "Path",
